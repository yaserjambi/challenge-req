...
@Component({
  selector: 'app-line-chart-challenge',
  standalone: false,
  templateUrl: './line-chart-challenge.component.html',
  styleUrl: './line-chart-challenge.component.scss'
})
export class LineChartChallengeComponent {
  data: any
